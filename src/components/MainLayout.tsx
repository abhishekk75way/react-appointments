...
const menuItems = [
  ...
  { text: "My Appointments", icon: <BookingIcon />, path: "/appointments" },
  { text: "Staff", icon: <StaffIcon />, path: "/profile/staff" },
        ...
        <Toolbar sx={styles.toolbar}>
          <Box display="flex" alignItems="center" gap={1.5}>
            <Box sx={styles.logoBox}>
              <BookingIcon sx={styles.logoIcon} />
            </Box>
            <Typography
              variant="h6"
              fontWeight={900}
